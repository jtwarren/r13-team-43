GravatarImageTag.configure do |config|
  # Set this to use your own default gravatar image rather then serving up Gravatar's
  # default image [ 'http://example.com/images/default_gravitar.jpg', :identicon,
  # :monsterid, :wavatar, 404 ].
  config.default_image           = :retro

  # Set this if you require a specific image file format ['gif', 'jpg' or 'png'].
  # Gravatar's default is png
  config.filetype                = nil
